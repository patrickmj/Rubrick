...
Rubrick.ui.Row = function(fieldsConfigArray, rowInitObj) {
    ...
    for (var i = 0; i < fieldsConfigArray.length; i++) {
        ...
        newField = Rubrick.ui.FieldFactory.getField(fieldsConfigArray[i].type, fieldsConfigArray[i].fieldName, configObj);
 ...
 */   
    ...
    this .processClick = function (event) {
        ...
        switch (target.action) {
            ...
            newField = Rubrick.ui.FieldFactory.getField('LongTextField', 'DummyLabel', {
...
Rubrick.util.extend = function(child, sup) {
...
Rubrick.ui.stopEvent = function(e) {
    if (!e) var e = window.event;
...
Rubrick.ui.Field = function(fieldName, configObj) {
...
Rubrick.ui.TextField = function(fieldName, configObj) {
...
//TODO:  refactor to use jQuery
	...
	addValue: function(value) {
		Rubrick.ui.Field.prototype.addValue.call(this, value);
		this.equalizeInputsAndValues();		
		this.updateInputs();
		this.updateDisplayContainer();
	},
...
Rubrick.util.extend(Rubrick.ui.TextField, Rubrick.ui.Field);
...
Rubrick.ui.ShortTextField = function(fieldName, configObj) {
...
Rubrick.ui.ShortTextField.prototype = { 
	...
	addInput: function(input) {
		if(!input) {
			...
			input.setAttribute('onclick', " Rubrick.ui.stopEvent(event); return false;" );
	...
	init: function() {
		...
		Rubrick.ui.TextField.prototype.init.call(this);

	}

}

Rubrick.util.extend(Rubrick.ui.ShortTextField, Rubrick.ui.TextField);
...
Rubrick.ui.LongTextField = function(fieldName, configObj) {
...
Rubrick.util.extend(Rubrick.ui.LongTextField, Rubrick.ui.TextField);
...
Rubrick.ui.EnumerationField = function(fieldName, configObj) {
	//this.allowedValues = [];
	this.values = [] ; 
...
Rubrick.util.extend(Rubrick.ui.EnumerationField, Rubrick.ui.Field);
...
Rubrick.ui.SingleEnumerationField = function(fieldName, configObj) {
...
Rubrick.util.extend(Rubrick.ui.SingleEnumerationField, Rubrick.ui.EnumerationField);

/*
	BooleanEnumerationField
*/

Rubrick.ui.BooleanEnumerationField = function(fieldName, configObj) {
...
Rubrick.util.extend(Rubrick.ui.BooleanEnumerationField, Rubrick.ui.SingleEnumerationField);

/*
	OrderedEnumerationField
*/

Rubrick.ui.OrderedEnumerationField = function(fieldName, configObj) {
...
Rubrick.util.extend(Rubrick.ui.OrderedEnumerationField, Rubrick.ui.SingleEnumerationField);
...
Rubrick.ui.UniqueEnumerationField = function(fieldName, configObj) {
...
Rubrick.util.extend(Rubrick.ui.UniqueEnumerationField, Rubrick.ui.SingleEnumerationField);
